...
const ContactForm = () => {
  ...
  return (
        <Fragment>
            <h1 className="text-left md:px-0 text-5xl font-bold md:inline-block py-2 rounded-md text-[#FFF]">Faça o seu negócio chegar a mais de 4000 clientes com um único email! </h1>
